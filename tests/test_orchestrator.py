...
class TestOrchestrationIntegration:
    ...
    def test_different_ensemble_methods_produce_different_results(self, medium_time_series):
        ...
        is_different = (
            not np.allclose(weighted_preds, equal_preds) or
            not np.allclose(equal_preds, median_preds)
        )
        assert is_different, "Different ensemble methods should produce different results"
