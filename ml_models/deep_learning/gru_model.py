...
class GRUModel(BaseTimeSeriesModel):
    ...
    GRU is similar to LSTM but with fewer parameters and faster training.

    Attributes:
        lookback: Number of past time steps to use.
        forecast_horizon: Number of steps ahead to predict.
        units_per_layer: Units in each GRU layer.
        num_layers: Number of stacked GRU layers (1-2).
    ...
    def __init__(
        ...
        Args:
            ...
            units_per_layer: GRU units per layer.
            num_layers: Number of GRU layers (1-2).
    ...
    def fit(
        ...
        try:
            ...
            # Second GRU layer (if num_layers > 1)
            ...
            logger.info(
                f"GRU model fitted with {len(X_norm)} samples, "
