...
class LightGBMModel(BaseTimeSeriesModel):
    ...
    def predict(self, steps: int) -> ForecastResult:
        ...
        try:
            ...
            recent_std = np.std(predictions[-3:]) if len(predictions) >= 3 else np.std([self._training_data.iloc[-1]])
            ...
            return ForecastResult(
                ...
                metadata={
                    ...
                    "feature_importance": self._diagnostics.get("feature_importance", {}),
                },
            )
